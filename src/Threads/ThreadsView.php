...
class ThreadsView
{
    ...
    public function drawThreadLink(Post $first)
    {
        ...
        $out = '<a  href="thread.php?t=' . $first->no . '&b=' . $first->getParent()->getParent()->shortTitle() . '"><div data-toggle="tooltip" data-html="true" title="<i class=\'fa fa-file-image-o\'></i> ' . $first->images . '<br/>' . str_replace('"', "\'", $first->com) . '" class="col-md-2 col-sm-3 col-xs-12 board">';
